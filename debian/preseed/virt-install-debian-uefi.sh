#!/bin/sh
# example: ./$0 /dev/vg_ssd/fastvm-debian-install /wd4tb/workdir/tmp/ISO/debian-9.3.0-amd64-DVD-1.iso debian-9.preseed
BASE_IMAGE_LV="$1"
ISO_LOCATION="$2"
KICKSTART="$3"
...
virsh --connect qemu:///system undefine --nvram debian-fastvm-install
