...
export GB_KERNEL_PACKAGE='>=sys-kernel/gentoo-sources-6.6.30'
export GB_KERNEL_CONFIG="https://raw.githubusercontent.com/OndrejHome/fast-vm-public-images/master/gentoo/gentoo-build-variables/config-6.6.38-x86-amd64.txt"
...
### System profile
export GB_ESELECT_PROFILE="default/linux/amd64/23.0/systemd"
