#!/bin/sh
# example: ./$0 /dev/vg_ssd/fastvm-ol-6.9 /wd4tb/workdir/tmp/ISO/OracleLinux-R6-U9-Server-x86_64-dvd.iso ol-6.ks
BASE_IMAGE_LV="$1"
ISO_LOCATION="$2"
KICKSTART="$3"
...
virsh --connect qemu:///system undefine ol-6-fastvm-install
