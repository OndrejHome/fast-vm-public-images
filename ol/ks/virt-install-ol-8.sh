#!/bin/sh
# example: ./$0 /dev/vg_ssd/fastvm-ol-8.0 /wd4tb/workdir/tmp/ISO/OracleLinux-R8-U0-Server-x86_64-dvd.iso ol-8.ks
BASE_IMAGE_LV="$1"
ISO_LOCATION="$2"
KICKSTART="$3"
...
virsh --connect qemu:///system undefine ol-8-fastvm-install
