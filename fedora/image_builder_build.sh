...
./image_builder.sh build f32 fedora/ks/virt-install-fedora.sh "$ISO_DIR/Fedora-Server-dvd-x86_64-32-1.6.iso" fedora/ks/fedora-32.ks | tee 1_build-f32.log
#===
...
./image_builder.sh test f32 42 fedora/xml/fedora-28-current.xml fedora/hacks/6g_fedora-32-hacks.sh | tee 2_test_f32.log
#===
