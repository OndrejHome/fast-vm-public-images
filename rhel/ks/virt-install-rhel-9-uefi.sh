#!/bin/sh
# example: ./$0 /dev/vg_ssd/fastvm-rhel-9.0-uefi /mnt/iso_storage/rhel/rhel-baseos-9.0-x86_64-dvd.iso rhel-9-uefi.ks
BASE_IMAGE_LV="$1"
ISO_LOCATION="$2"
KICKSTART="$3"
...
virt-install \
--connect qemu:///system \
--name rhel-9-uefi-fastvm-install \
...
virsh --connect qemu:///system undefine --nvram rhel-9-uefi-fastvm-install
