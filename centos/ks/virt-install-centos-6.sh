#!/bin/sh
# example: ./$0 /dev/vg_ssd/fastvm-cent-6.3 /wd4tb/workdir/tmp/ISO/CentOS-6.3-x86_64-bin-DVD1.iso centos-6.ks
BASE_IMAGE_LV="$1"
ISO_LOCATION="$2"
KICKSTART="$3"
...
virsh --connect qemu:///system undefine centos-6-fastvm-install
