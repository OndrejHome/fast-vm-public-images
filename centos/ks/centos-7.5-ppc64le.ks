...
part None --fstype "PPC PReP Boot" --size 4
...
%post --nochroot
sed -i "s/ONBOOT=no/ONBOOT=yes/" /mnt/sysimage/etc/sysconfig/network-scripts/ifcfg-eth0
echo "ppc64le" > /mnt/sysimage/etc/hostname
