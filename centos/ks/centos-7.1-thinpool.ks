...
logvol none --fstype="None" --size=4500 --thinpool --name=system_pool --vgname=c7vg
logvol swap  --fstype="swap" --size=256 --name=swap_lv --thin --poolname=system_pool --vgname=c7vg
logvol /  --fstype="xfs" --size=4000 --thin --poolname=system_pool --name=root_lv --vgname=c7vg
